...
const getXINRBooks = async function (req, res){
    const findbook = await BookModel.find({$or :[{"price.indianPrice":"100INR"},{"price.indianPrice":"300INR"},{"price.indianPrice":"500INR"}]})
    res.send({msg : findbook})
}

// 6th
const getRandomBooks= async function (req, res){
    const showbook = await BookModel.find({stockAvailable:true, totalPages:{$gt:500}})
